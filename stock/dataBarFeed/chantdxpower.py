...
def show_chan_mpl_power(code, start_date=None, end_date=None, stock_days=30, resample='d', show_mpl=True, least_init=3, chanK_flag=False, windows=20, power=True, fb_show=0,df=None):
